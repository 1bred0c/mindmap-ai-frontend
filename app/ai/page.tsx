...
export default function AIPage() {
  ...
  const createMindMap = () => {
    ...
    // Store generated data in sessionStorage to pass to the mindmap editor
    sessionStorage.setItem('aiGeneratedMindmap', JSON.stringify(generatedData));
    
    // Navigate to create new mindmap page
          ...
          <Card className="max-w-4xl mx-auto border-green-500">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-end space-x-2 pt-4 border-t">
                <Button variant="outline" onClick={handleRegenerateNew}>
                  Tạo mới
                </Button>
